...
namespace Drupal\hr_paragraphs\Plugin\ExternalEntities\StorageClient;
...
class RestJson extends Rest implements PluginFormInterface {
  ...
  public function getHttpHeaders() {
    ...
    if ($this->configuration['api_key']['header_name'] && $this->configuration['api_key']['key']) {
      $headers[$this->configuration['api_key']['header_name']] = hr_paragraphs_get_endpoint_apikey($this->configuration['api_key']['key']);
    }
  ...
  public function getDocstoreEndpoint() {
    return hr_paragraphs_get_endpoint_base($this->configuration['endpoint']);
  }
