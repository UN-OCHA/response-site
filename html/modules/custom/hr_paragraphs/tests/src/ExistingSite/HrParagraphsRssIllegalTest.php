...
use Drupal\Tests\hr_paragraphs\Traits\RssIllegalTestDataTrait;
 ...
 * Tests RSS feed.
 */
class HrParagraphsRssIllegalTest extends ExistingSiteBase {

  use RssIllegalTestDataTrait;
  ...
  public function testRssOnPageCustomReadMore() {
    ...
    $this->assertStringNotContainsString('https://www.example.com/readmore', $output);
